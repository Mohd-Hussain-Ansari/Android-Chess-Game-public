...
import com.hussain.chess.utils.Computer;
...
public class ComputerGameActivity extends AppCompatActivity {
    ...
    private TextView txtWhiteTimer;
    private TextView txtBlackTimer;
    ...
    private boolean isUndoRedoTake =false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if( actionBar != null){
            ...
            actionBar.setTitle(R.string.play_with_computer);
        ...
        if (extras != null) {
             ...
             if(extras.containsKey("tempSavedGameID")){
                int id = extras.getInt("tempSavedGameID");
                AppDatabase db = AppDatabase.getDbInstance(ComputerGameActivity.this);

                TempSavedComputerGameDao tempSavedComputerGameDao = db.tempSavedComputerGameDao();
                String json= tempSavedComputerGameDao.getById(id).gameObject;
                GsonBuilder gsonBuilder = new GsonBuilder();
                gsonBuilder.registerTypeAdapter(Piece.class, new InterfaceAdapter<Piece>());
                Gson gson = gsonBuilder.create();

                game=gson.fromJson(json,Computer.class);
                ...
                for (Piece pieceKilled:
                 ...
                 playerPiece=extras.getString("selectPiece");
                 Player p1, p2;
                 // is user select white piece

                 if(playerPiece.equalsIgnoreCase(getString(R.string.white))){
                     p1 = new Player(true,false);
                     p2 = new Player(false,true);
                     p1.name=extras.getString("playerName");
                     p2.name=getString(R.string.computer);

                 }
                 // is user select black piece
                 else  if(playerPiece.equalsIgnoreCase(getString(R.string.black))){
                     p1 = new Player(true,true);
                     p2 = new Player(false,false);
                     p1.name=getString(R.string.computer);
                     p2.name=extras.getString("playerName");
                     isUserBlack=true;
                 }
                 // user select random piece
                 else{
                     if(Math.random() < 0.5) {
                         p1 = new Player(true,false);
                         p2 = new Player(false,true);
            ...
            if(isUserBlack){
                ...
                imgPlayer1.setImageResource(R.drawable.bk);
                imgPlayer2.setImageResource(R.drawable.wk);

                TextView txtPlayer1= findViewById(R.id.txtPlayer2);
                txtPlayer1.setText(game.getPlayerName(0));
                TextView txtPlayer2= findViewById(R.id.txtPlayer1);
                txtPlayer2.setText(game.getPlayerName(1));

                txtWhiteTimer = findViewById(R.id.txtBlackTimer);
                txtBlackTimer = findViewById(R.id.txtWhiteTimer);


                String cellColor="dark";
                for (int i = 7; i >= 0; i--) {
                    for (int j = 7; j >= 0; j--) {
                        imageView = new ImageView(ComputerGameActivity.this);
                ...
                txtWhiteTimer = findViewById(R.id.txtWhiteTimer);
                txtBlackTimer = findViewById(R.id.txtBlackTimer);
            ...
            if(whiteTimer==0 && blackTimer==0){
               txtBlackTimer.setVisibility(View.GONE);
               txtWhiteTimer.setVisibility(View.GONE);
            ...
            if(isShowLastMove &&  extras.containsKey("tempSavedGameID") ){
                // show last move
            ...
            if(isSound){
                MediaPlayer music;
                music = MediaPlayer.create(ComputerGameActivity.this, R.raw.move_self);
    ...
    protected void onPause() {
        ...
        if(game.isUserCanSaveGame()){
            ...
            game.tempSavedComputerGame(getApplicationContext(),timerLimit,blackTimer,whiteTimer, isShowValidAvailableMove,isShowLastMove,isSound,isUndoRedo,
                    isChangeSettings,isUserBlack);
    ...
    protected void onResume() {
        ...
        AppDatabase db=AppDatabase.getDbInstance(ComputerGameActivity.this);
        TempSavedComputerGameDao tempSavedComputerGameDao = db.tempSavedComputerGameDao();
        tempSavedComputerGameDao.deleteById(1);
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
        ...
        try {
            ...
            if (!game.isEnd()) {
                ...
                // is current turn player is not a computer
        ...
        /*    AlertDialog.Builder builder = new AlertDialog.Builder(ComputerGameActivity.this);
    ...
    private void changePosition(View view, int x, int y) throws Exception {
        ...
        if (game.playerMove(game.getCurrentTurn(), spot.getX(), spot.getY(), x, y)) {
            ...
            if (move.isCastlingMove()) {
                ...
                ImageView imageView;
                AlertDialog.Builder dialog = new AlertDialog.Builder(ComputerGameActivity.this);

                LinearLayout linearLayout = new LinearLayout(ComputerGameActivity.this);
            ...
            if(killedPiece!=null){
                ...
                if(isSound){
                    MediaPlayer music;
                    music = MediaPlayer.create(ComputerGameActivity.this, R.raw.capture);
    ...
    private void endWindow() {
        ...
        linearLayout.setGravity(Gravity.CENTER);
        Button btnResetBoard = new Button(ComputerGameActivity.this);
        btnResetBoard.setText(R.string.reset_board);
        Button btnMainMenu = new Button(ComputerGameActivity.this);
        ...
        btnMainMenu.setOnClickListener(v -> {
            ...
            startActivity(intent);
            ComputerGameActivity.this.finish();
        });

        if(isSound){
            MediaPlayer music = MediaPlayer.create(ComputerGameActivity.this, R.raw.notify);
    ...
    public void showOptions() {
        ...
        Button btnResign = new Button(ComputerGameActivity.this);
        ...
        if(isChangeSettings){
            //undoRedoMoveLayout
            LinearLayout undoRedoMoveLayout=new LinearLayout(ComputerGameActivity.this);
            undoRedoMoveLayout.setOrientation(LinearLayout.HORIZONTAL);
            undoRedoMoveLayout.setWeightSum(2);

            TextView txtUndoRedoMove = new TextView(ComputerGameActivity.this);
            txtUndoRedoMove.setText(R.string.undo_and_redo_move);
            txtUndoRedoMove.setLayoutParams(params1);

            SwitchCompat switchUndoRedoMove=new SwitchCompat(ComputerGameActivity.this);
            ...
            LinearLayout showAvailableMoveLayout=new LinearLayout(ComputerGameActivity.this);
            showAvailableMoveLayout.setOrientation(LinearLayout.HORIZONTAL);
            showAvailableMoveLayout.setWeightSum(2);

            TextView txtAvailableMove = new TextView(ComputerGameActivity.this);
            txtAvailableMove.setText(R.string.show_valid_piece_move);
            txtAvailableMove.setLayoutParams(params1);

            SwitchCompat switchAvailableMove=new SwitchCompat(ComputerGameActivity.this);
            ...
            //showLastMoveLayout
            LinearLayout showLastMoveLayout=new LinearLayout(ComputerGameActivity.this);
            showLastMoveLayout.setOrientation(LinearLayout.HORIZONTAL);
            showLastMoveLayout.setWeightSum(2);

            TextView txtLastMove = new TextView(ComputerGameActivity.this);
            txtLastMove.setText(R.string.show_last_moved_piece);
            txtLastMove.setLayoutParams(params1);

            SwitchCompat switchLastMove=new SwitchCompat(ComputerGameActivity.this);
        ...
        //soundLayout
        LinearLayout soundLayout=new LinearLayout(ComputerGameActivity.this);
        soundLayout.setOrientation(LinearLayout.HORIZONTAL);
        soundLayout.setWeightSum(2);

        TextView txtSound = new TextView(ComputerGameActivity.this);
        txtSound.setText(R.string.sound);
        txtSound.setLayoutParams(params1);

        SwitchCompat switchSound=new SwitchCompat(ComputerGameActivity.this);
   ...
   private void showCastlingLastMove(ImageView imageView,int index){
            ...
            if(lastMove!=null){
                ...
                if(undoMove.isEnpersandMove()){
                    ...
                    //last piece moved is black piece
                        ...
                        endPositionImageview.setBackgroundResource(R.drawable.bp);
                    }
                }
    ...
    public void showCurrentTurn(){
        ImageView whiteKingImage,blackKingImage;
        if(isUserBlack){
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
    public void moveComputer() throws InterruptedException {
        if(game.getCurrentTurn().isComputer()){
            ...
            new Handler().postDelayed(() -> {
                try {
                    ...
                    beforeImage =gridLayout.findViewById(Integer.parseInt("" + move.getStart().getX() + move.getStart().getY()));
                    afterImage =gridLayout.findViewById(Integer.parseInt("" + move.getEnd().getX() + move.getEnd().getY()));
                    ...
                    if(isShowLastMove){
                        ...
                        // show last move
                        showLastMove(beforeImage,afterImage,move.getPieceMoved());
                    }
